...
const le = 6048e5, xe = 864e5, K = Symbol.for("constructDateFrom");
function S(o, e) {
  return typeof o == "function" ? o(e) : o && typeof o == "object" && K in o ? o[K](e) : o instanceof Date ? new o.constructor(e) : new Date(e);
}
function E(o, e) {
  return S(e || o, o);
}
...
function N(o, e) {
  var c, s, l, d;
  const t = V(), n = (e == null ? void 0 : e.weekStartsOn) ?? ((s = (c = e == null ? void 0 : e.locale) == null ? void 0 : c.options) == null ? void 0 : s.weekStartsOn) ?? t.weekStartsOn ?? ((d = (l = t.locale) == null ? void 0 : l.options) == null ? void 0 : d.weekStartsOn) ?? 0, a = E(o, e == null ? void 0 : e.in), r = a.getDay(), i = (r < n ? 7 : 0) + r - n;
  return a.setDate(a.getDate() - i), a.setHours(0, 0, 0, 0), a;
}
function H(o, e) {
  return N(o, { ...e, weekStartsOn: 1 });
}
function ue(o, e) {
...
function ve(o, e, t) {
  const [n, a] = he(
    ...
    o,
    e
  ), r = U(n), i = U(a), c = +r - Q(r), s = +i - Q(i);
  return Math.round((c - s) / xe);
}
function Te(o, e) {
  const t = ue(o, e), n = S(o, 0);
...
function ke(o) {
  return !(!we(o) && typeof o != "number" || isNaN(+E(o)));
}
function Ce(o, e) {
  const t = E(o, e == null ? void 0 : e.in);
...
function z(o) {
  return (e, t = {}) => {
    ...
    if (!r)
      return null;
    const i = r[0], c = n && o.parsePatterns[n] || o.parsePatterns[o.defaultParseWidth], s = Array.isArray(c) ? qe(c, (h) => h.test(i)) : (
...
const Ue = /^(\d+)(th|st|nd|rd)?/i, Ve = /\d+/i, Ye = {
  narrow: /^(b|a)/i,
...
function ot(o, e) {
  const t = E(o, e == null ? void 0 : e.in), n = +H(t) - +Te(t);
  return Math.round(n / le) + 1;
}
function ge(o, e) {
  var d, h, u, p;
  const t = E(o, e == null ? void 0 : e.in), n = t.getFullYear(), a = V(), r = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((h = (d = e == null ? void 0 : e.locale) == null ? void 0 : d.options) == null ? void 0 : h.firstWeekContainsDate) ?? a.firstWeekContainsDate ?? ((p = (u = a.locale) == null ? void 0 : u.options) == null ? void 0 : p.firstWeekContainsDate) ?? 1, i = S((e == null ? void 0 : e.in) || o, 0);
  i.setFullYear(n + 1, 0, r), i.setHours(0, 0, 0, 0);
  const c = N(i, e), s = S((e == null ? void 0 : e.in) || o, 0);
...
function it(o, e) {
  var c, s, l, d;
  const t = V(), n = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((s = (c = e == null ? void 0 : e.locale) == null ? void 0 : c.options) == null ? void 0 : s.firstWeekContainsDate) ?? t.firstWeekContainsDate ?? ((d = (l = t.locale) == null ? void 0 : l.options) == null ? void 0 : d.firstWeekContainsDate) ?? 1, a = ge(o, e), r = S((e == null ? void 0 : e.in) || o, 0);
  return r.setFullYear(a, 0, n), r.setHours(0, 0, 0, 0), N(r, e);
}
function st(o, e) {
  const t = E(o, e == null ? void 0 : e.in), n = +N(t, e) - +it(t, e);
  return Math.round(n / le) + 1;
}
function T(o, e) {
...
const ne = (o, e) => {
  ...
  return r.replace("{{date}}", ne(n, e)).replace("{{time}}", pe(a, e));
}, lt = {
  p: pe,
  P: ct
}, dt = /^D+$/, ut = /^Y+$/, ht = ["D", "DD", "YY", "YYYY"];
function gt(o) {
  return dt.test(o);
}
function pt(o) {
...
function bt(o, e, t) {
  const n = mt(o, e, t);
  if (console.warn(n), ht.includes(o)) throw new RangeError(n);
}
function mt(o, e, t) {
...
const ft = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, xt = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, yt = /^'([^]*?)'?$/, vt = /''/g, Tt = /[a-zA-Z]/;
function D(o, e, t) {
  var d, h, u, p;
  const n = V(), a = n.locale ?? at, r = n.firstWeekContainsDate ?? ((h = (d = n.locale) == null ? void 0 : d.options) == null ? void 0 : h.firstWeekContainsDate) ?? 1, i = n.weekStartsOn ?? ((p = (u = n.locale) == null ? void 0 : u.options) == null ? void 0 : p.weekStartsOn) ?? 0, c = E(o, t == null ? void 0 : t.in);
  if (!ke(c))
    throw new RangeError("Invalid time value");
  let s = e.match(xt).map((g) => {
    const m = g[0];
    if (m === "p" || m === "P") {
      const b = lt[m];
...
function St(o) {
  try {
    ...
    if ((!e || typeof e != "string") && (e = (orca.state.locale || "zh-CN").startsWith("zh") ? "yyyy年MM月dd日" : "yyyy-MM-dd"), kt(o))
      return "今天";
    if (Pt(o))
      return "昨天";
    if (Ct(o))
...
function Yt(o, e, t = {}) {
  try {
    ...
    e[i].isPinned = !e[i].isPinned, n && Jt(e);
...
function on(o, e, t) {
  ...
  c.type = "range", c.min = "120", c.max = "800", c.value = o.toString(), c.style.cssText = Ut();
  ...
  d.className = "btn btn-primary", d.textContent = "确定", d.style.cssText = oe(), d.onclick = () => ie(n);
...
class ln {
  constructor() {
    ...
    // 防抖函数实例（仅用于拖拽等非关键场景）
    f(this, "draggingDebounce", tn(async () => {
   ...
   */
  sortTabsByPinStatus() {
    const e = this.getCurrentPanelTabs(), t = Qt(e);
...
`)[0].trim();
  ...
  createTabElement(e) {
    ...
    return t.appendChild(i), this.isVerticalMode && !this.resizeHandle && this.enableDragResize(), t.title = qt(e), t.addEventListener("click", (s) => {
      var d;
  ...
  async toggleTabPinStatus(e) {
    const t = this.getCurrentPanelTabs(), n = Yt(e, t, {
      updateOrder: !0,
      saveData: !0,
      updateUI: !0
    });
    n.success ? (this.syncCurrentTabsToStorage(t), await this.immediateUpdateTabsUI(), await this.saveCurrentPanelTabs(), this.enableWorkspaces && this.currentWorkspace && (await this.saveCurrentTabsToWorkspace(), this.log(`🔄 标签页固定状态变化，实时更新工作区: ${e.title}`)), this.log(n.message)) : this.warn(n.message);
  }
  /* ———————————————————————————————————————————————————————————————————————————— */
  ...
  async closeAllTabs() {
    ...
    this.setCurrentPanelTabs(n), this.syncCurrentTabsToStorage(n), await this.immediateUpdateTabsUI(), await this.saveCurrentPanelTabs(), await this.saveClosedTabs(), this.enableWorkspaces && this.currentWorkspace && (await this.saveCurrentTabsToWorkspace(), this.log("🔄 批量关闭标签页，实时更新工作区")), this.log(`🗑️ 已关闭 ${a} 个标签，保留了 ${n.length} 个固定标签`);
  }
  /**
   * 关闭其他标签页（保留当前标签和固定标签）
   */
  async closeOtherTabs(e) {
    ...
    this.setCurrentPanelTabs(n), this.syncCurrentTabsToStorage(n), await this.immediateUpdateTabsUI(), await this.saveCurrentPanelTabs(), await this.saveClosedTabs(), this.enableWorkspaces && this.currentWorkspace && (await this.saveCurrentTabsToWorkspace(), this.log("🔄 关闭其他标签页，实时更新工作区")), this.log(`🗑️ 已关闭其他 ${r} 个标签，保留了当前标签和固定标签`);
  }
  /**
   * 重命名标签（内联编辑）
   */
  ...
  async updateTabTitle(e, t) {
    try {
      const n = this.getCurrentPanelTabs(), a = Xt(e, t, n, {
        updateUI: !0,
        saveData: !0,
        validateData: !0
      });
  ...
  async restorePosition() {
    try {
      this.position = R(
        ...
        this.verticalPosition,
        this.horizontalPosition
      ), this.position = At(this.position, this.isVerticalMode, this.verticalWidth), this.log(`📍 位置已恢复: ${re(this.position, this.isVerticalMode)}`);
    } catch {
      this.warn("无法恢复标签位置");
    }
  }
  ...
  async restoreLayoutMode() {
    try {
      ...
      if (e) {
        const t = Wt(e);
        this.isVerticalMode = t.isVerticalMode, this.verticalWidth = t.verticalWidth, this.verticalPosition = t.verticalPosition, this.horizontalPosition = t.horizontalPosition, this.position = R(
          this.isVerticalMode,
          this.verticalPosition,
          this.horizontalPosition
        ), this.isSidebarAlignmentEnabled = t.isSidebarAlignmentEnabled, this.isFloatingWindowVisible = t.isFloatingWindowVisible, this.showBlockTypeIcons = t.showBlockTypeIcons, this.showInHeadbar = t.showInHeadbar, this.log(`📐 布局模式已恢复: ${Ot(t)}, 当前位置: (${this.position.x}, ${this.position.y})`);
      } else {
        const t = _();
        this.isVerticalMode = t.isVerticalMode, this.verticalWidth = t.verticalWidth, this.verticalPosition = t.verticalPosition, this.horizontalPosition = t.horizontalPosition, this.position = R(
          this.isVerticalMode,
  ...
  constrainPosition() {
    ...
    this.position = en(this.position, this.isVerticalMode, this.verticalWidth, e);
  }
  /**
   * 检查新添加的块
   */
  ...
  async checkCurrentPanelBlocks() {
    ...
    if (c) {
      this.log(`📋 找到已存在的标签页: "${c.title}" (${r})`), this.closedTabs.has(r) && (this.closedTabs.delete(r), await this.saveClosedTabs(), this.log(`🔄 标签 "${c.title}" 重新激活，从已关闭列表中移除`)), this.updateFocusState(r, c.title), await this.immediateUpdateTabsUI();
      return;
    }
  ...
  observeChanges() {
    new MutationObserver(async (a) => {
      ...
      }), c && (await this.updateCurrentPanelIndex(), s !== this.currentPanelIndex && (this.log(`🔄 面板切换: ${s} -> ${this.currentPanelIndex}`), await this.immediateUpdateTabsUI())), i && setTimeout(async () => {
    ...
    document.addEventListener("click", n), document.addEventListener("focusin", n), document.addEventListener("keydown", (a) => {
      (a.key === "Tab" || a.key === "Enter" || a.key === " ") && (t && clearTimeout(t), t = window.setTimeout(n, 0));
    }), setInterval(async () => {
      var a;
      try {
        ...
        if (r) {
          ...
          if (i) {
            const c = i.getAttribute("data-block-id");
            if (c) {
              const s = (a = this.tabContainer) == null ? void 0 : a.querySelector('.orca-tab[data-focused="true"]');
              if (s) {
                const l = s.getAttribute("data-tab-id");
                l !== c && (this.verboseLog(`🔄 主动检测到块变化: ${l} -> ${c}`), await this.checkCurrentPanelBlocks());
              } else
                this.verboseLog(`🔄 主动检测到无聚焦标签页，当前块: ${c}`), await this.checkCurrentPanelBlocks();
            }
          }
        }
      } catch {
...
let I = null;
async function un(o) {
  q = o, orca.state.locale, I = new ln(), document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", () => {
