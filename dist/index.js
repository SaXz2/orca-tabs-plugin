...
class Se {
  ...
  async loadWorkspaces() {
    try {
      const e = await this.storageService.getConfig(x.WORKSPACES), t = e && Array.isArray(e) ? e : [], a = await this.storageService.getConfig(x.ENABLE_WORKSPACES), r = typeof a == "boolean" ? a : !1;
  ...
  async saveWorkspaces(e, t, a) {
    try {
      await this.storageService.saveConfig(x.WORKSPACES, e, this.pluginName), await this.storageService.saveConfig(x.CURRENT_WORKSPACE, t, this.pluginName), await this.storageService.saveConfig(x.ENABLE_WORKSPACES, a, this.pluginName), this.log("💾 工作区数据已保存");
    } catch (r) {
...
const pe = 6048e5, Ie = 864e5, te = Symbol.for("constructDateFrom");
function I(s, e) {
...
function ge(s, e, t) {
  const a = E(s, t == null ? void 0 : t.in);
  return isNaN(e) ? I(s, NaN) : (e && a.setDate(a.getDate() + e), a);
}
let Ee = {};
function Y() {
  return Ee;
...
function U(s, e) {
  var o, c, l, d;
  const t = Y(), a = (e == null ? void 0 : e.weekStartsOn) ?? ((c = (o = e == null ? void 0 : e.locale) == null ? void 0 : o.options) == null ? void 0 : c.weekStartsOn) ?? t.weekStartsOn ?? ((d = (l = t.locale) == null ? void 0 : l.options) == null ? void 0 : d.weekStartsOn) ?? 0, r = E(s, e == null ? void 0 : e.in), i = r.getDay(), n = (i < a ? 7 : 0) + i - a;
  return r.setDate(r.getDate() - n), r.setHours(0, 0, 0, 0), r;
}
function V(s, e) {
  return U(s, { ...e, weekStartsOn: 1 });
}
function me(s, e) {
  const t = E(s, e == null ? void 0 : e.in), a = t.getFullYear(), r = I(t, 0);
...
function $e(s, e, t) {
  const [a, r] = be(
    ...
    s,
    e
  ), i = j(a), n = j(r), o = +i - ae(i), c = +n - ae(n);
  return Math.round((o - c) / Ie);
}
function Me(s, e) {
  const t = me(s, e), a = I(s, 0);
...
function q(s) {
  return (e, t = {}) => {
    ...
    if (!i)
      return null;
    const n = i[0], o = a && s.parsePatterns[a] || s.parsePatterns[s.defaultParseWidth], c = Array.isArray(o) ? Je(o, (u) => u.test(n)) : (
...
function gt(s, e) {
  const t = E(s, e == null ? void 0 : e.in), a = +V(t) - +Me(t);
  return Math.round(a / pe) + 1;
}
function fe(s, e) {
  var d, u, h, p;
  const t = E(s, e == null ? void 0 : e.in), a = t.getFullYear(), r = Y(), i = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((u = (d = e == null ? void 0 : e.locale) == null ? void 0 : d.options) == null ? void 0 : u.firstWeekContainsDate) ?? r.firstWeekContainsDate ?? ((p = (h = r.locale) == null ? void 0 : h.options) == null ? void 0 : p.firstWeekContainsDate) ?? 1, n = I((e == null ? void 0 : e.in) || s, 0);
  n.setFullYear(a + 1, 0, i), n.setHours(0, 0, 0, 0);
  const o = U(n, e), c = I((e == null ? void 0 : e.in) || s, 0);
...
function mt(s, e) {
  var o, c, l, d;
  const t = Y(), a = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((c = (o = e == null ? void 0 : e.locale) == null ? void 0 : o.options) == null ? void 0 : c.firstWeekContainsDate) ?? t.firstWeekContainsDate ?? ((d = (l = t.locale) == null ? void 0 : l.options) == null ? void 0 : d.firstWeekContainsDate) ?? 1, r = fe(s, e), i = I((e == null ? void 0 : e.in) || s, 0);
  return i.setFullYear(r, 0, a), i.setHours(0, 0, 0, 0), U(i, e);
}
function bt(s, e) {
  const t = E(s, e == null ? void 0 : e.in), a = +U(t, e) - +mt(t, e);
  return Math.round(a / pe) + 1;
}
function w(s, e) {
...
const M = {
  ...
  y(s, e) {
    ...
    return w(e === "yy" ? a % 100 : a, e.length);
  },
  // Month
  M(s, e) {
    const t = s.getMonth();
  ...
  w: function(s, e, t, a) {
    const r = bt(s, a);
    return e === "wo" ? t.ordinalNumber(r, { unit: "week" }) : w(r, e.length);
  },
  // ISO week of year
  I: function(s, e, t) {
    const a = gt(s);
    return e === "Io" ? t.ordinalNumber(a, { unit: "week" }) : w(a, e.length);
  },
  // Day of the month
  d: function(s, e, t) {
  ...
  D: function(s, e, t) {
    const a = pt(s);
    return e === "Do" ? t.ordinalNumber(a, { unit: "dayOfYear" }) : w(a, e.length);
  },
  // Day of week
  E: function(s, e, t) {
    const a = s.getDay();
  ...
  b: function(s, e, t) {
    const a = s.getHours();
    let r;
    switch (a === 12 ? r = W.noon : a === 0 ? r = W.midnight : r = a / 12 >= 1 ? "pm" : "am", e) {
      case "b":
      case "bb":
        return t.dayPeriod(r, {
          width: "abbreviated",
  ...
  B: function(s, e, t) {
    const a = s.getHours();
    let r;
    switch (a >= 17 ? r = W.evening : a >= 12 ? r = W.afternoon : a >= 4 ? r = W.morning : r = W.night, e) {
      case "B":
      case "BB":
      case "BBB":
        return t.dayPeriod(r, {
  ...
  K: function(s, e, t) {
    ...
    return e === "Ko" ? t.ordinalNumber(a, { unit: "hour" }) : w(a, e.length);
  },
  // Hour [1-24]
  k: function(s, e, t) {
    let a = s.getHours();
    return a === 0 && (a = 24), e === "ko" ? t.ordinalNumber(a, { unit: "hour" }) : w(a, e.length);
  },
  // Minute
  m: function(s, e, t) {
...
function ie(s, e = "") {
  ...
  return i === 0 ? t + String(r) : t + String(r) + e + w(i, 2);
}
function ne(s, e) {
  return s % 60 === 0 ? (s > 0 ? "-" : "+") + w(Math.abs(s) / 60, 2) : O(s, e);
}
function O(s, e = "") {
  const t = s > 0 ? "-" : "+", a = Math.abs(s), r = w(Math.trunc(a / 60), 2), i = w(a % 60, 2);
  return t + r + e + i;
}
const se = (s, e) => {
  switch (s) {
  ...
  return i.replace("{{date}}", se(a, e)).replace("{{time}}", ye(r, e));
}, yt = {
  p: ye,
  P: ft
...
function Ct(s, e, t) {
  const a = Pt(s, e, t);
  if (console.warn(a), Tt.includes(s)) throw new RangeError(a);
}
function Pt(s, e, t) {
...
function D(s, e, t) {
  var d, u, h, p;
  const a = Y(), r = a.locale ?? ht, i = a.firstWeekContainsDate ?? ((u = (d = a.locale) == null ? void 0 : d.options) == null ? void 0 : u.firstWeekContainsDate) ?? 1, n = a.weekStartsOn ?? ((p = (h = a.locale) == null ? void 0 : h.options) == null ? void 0 : p.weekStartsOn) ?? 0, o = E(s, t == null ? void 0 : t.in);
  if (!Ae(o))
...
function _t(s, e, t) {
  ...
  if (s.color)
    try {
      n = `--tab-color: ${s.color.startsWith("#") ? s.color : `#${s.color}`};`, a = "var(--orca-tab-colored-bg)", r = "var(--orca-tab-colored-text)", i = "600";
    } catch {
    }
  return e ? `
    ${n}
...
function Kt(s, e, t = {}) {
  try {
    ...
    e[n].isPinned = !e[n].isPinned, a && aa(e);
  ...
  analyzeTrends() {
    ...
    return this.metrics.forEach((t, a) => {
      ...
      if (r.length > 0 && i.length > 0) {
        const n = r.reduce((d, u) => d + u.value, 0) / r.length, o = i.reduce((d, u) => d + u.value, 0) / i.length, c = o > 0 ? (n - o) / o * 100 : 0;
        let l;
...
const z = class z {
  ...
  async performInitialization(e) {
    try {
      e && this.applyConfig(e), this.config.mutationObserver && (this.mutationObserver = new ca(
      ...
      )), this.config.debounce.length > 0 && (this.debounceOptimizer = new la(), this.config.debounce.forEach((t) => {
        this.debounceOptimizer.addLayer(t.name, t);
      })), this.config.memoryLeak.enableAutoCleanup && (this.memoryLeakProtector = X.getInstance(), this.memoryLeakProtector.setAutoCleanup(!0, this.config.memoryLeak.autoCleanupInterval)), this.config.lazyLoading && (this.lazyLoadingOptimizer = new da(this.config.lazyLoading)), this.config.batchProcessing && (this.batchProcessor = new ua(this.config.batchProcessing)), this.config.performanceMonitoring.enableMonitoring && (this.performanceMonitor = J.getInstance(), this.performanceMonitor.updateConfig({
...
function pa(s, e, t, a) {
  const r = document.createElement("div");
  r.className = "orca-tabs-plugin orca-tabs-container";
  const i = Jt(s, e, a, t);
...
function ga(s, e, t) {
  ...
  d.className = "btn btn-primary", d.textContent = "确定", d.style.cssText = ce(), d.onclick = () => le(a);
...
class fa {
  ...
  constructor(e) {
    ...
    // 防抖函数实例（仅用于拖拽等非关键场景）
    g(this, "draggingDebounce", oa(async () => {
  ...
  initializePerformanceOptimizers() {
    try {
      this.performanceOptimizer = K.getInstance();
    } catch (e) {
  ...
  /** 简单日志 - 只在调试模式下启用 */
  log(...e) {
    typeof window < "u" && window.DEBUG_ORCA_TABS && console.log("[OrcaPlugin]", ...e);
  }
  /** 警告日志 - 始终显示警告 */
  warn(...e) {
    console.warn("[OrcaPlugin]", ...e);
  }
  /** 错误日志 - 始终显示错误 */
  error(...e) {
    console.error("[OrcaPlugin]", ...e);
  }
  /**
   * 获取下一个对话框层级
  ...
  async init() {
    if (this.performanceOptimizer)
      try {
        ...
        this.error("性能优化管理器初始化失败:", n);
      }
    ma(), this.tabStorageService = new Se(this.storageService, this.pluginName, {
      log: this.log.bind(this),
      warn: this.warn.bind(this),
      error: this.error.bind(this),
      verboseLog: this.log.bind(this)
      // 临时使用log代替verboseLog
    });
    try {
    ...
    this.workspaces = e, this.enableWorkspaces = t, this.registerHeadbarButton(), await this.discoverPanels(), this.getFirstPanel(), typeof window < "u" && window.DEBUG_ORCA_TABS !== !1 && await this.storageService.testConfigSerialization();
    ...
    if (i && !i.startsWith("_") && (this.currentPanelId = i, this.currentPanelIndex = this.getPanelIds().indexOf(i)), this.ensurePanelTabsDataSize(), this.panelOrder.length > 1)
      for (let n = 1; n < this.panelOrder.length; n++) {
        const o = `panel_${n + 1}_tabs`;
        try {
          const c = await this.storageService.getConfig(o, this.pluginName, []);
          c && c.length > 0 ? this.panelTabsData[n] = [...c] : this.panelTabsData[n] = [];
        } catch (c) {
          this.log(`加载第 ${n + 1} 个面板数据失败:`, c), this.panelTabsData[n] = [];
        }
      }
    if (i && this.currentPanelIndex !== 0)
      ...
      if (n) {
        ...
        if (o) {
          ...
          c && (this.getCurrentPanelTabs().find((u) => u.blockId === c) || await this.checkCurrentPanelBlocks());
        }
      }
    }
    await this.autoDetectAndSyncCurrentFocus(), await this.createTabsUI(), this.observeChanges(), this.observeWindowResize(), this.initializeOptimizedDOMObserver(), this.startActiveMonitoring(), this.setupDragEndListener(), this.setupThemeChangeListener(), this.setupScrollListener(), this.setupSettingsChecker(), this.isInitialized = !0;
  }
  /**
  ...
  async autoDetectAndSyncCurrentFocus() {
    try {
      ...
      a !== -1 && (this.currentPanelIndex = a, this.currentPanelId = t);
      ...
      o.length === 0 && (await this.scanCurrentPanelTabs(), o = this.getCurrentPanelTabs());
      const c = o.find((d) => d.blockId === n);
      if (c) {
        this.updateFocusState(n, c.title), await this.immediateUpdateTabsUI();
        return;
      }
      ...
      if (o.length >= this.maxTabs) {
        ...
        l.order = o.length, o.push(l);
      this.setCurrentPanelTabs(o), await this.saveCurrentPanelTabs(), this.updateFocusState(n, l.title), await this.immediateUpdateTabsUI();
    } catch (e) {
  ...
  async handlePanelClosure(e) {
    ...
    for (let a = 0; a < this.panelOrder.length; a++) {
      const r = this.panelTabsData[a] || [], i = a === 0 ? x.FIRST_PANEL_TABS : `panel_${a + 1}_tabs`;
  ...
  updatePanelOrder(e) {
    this.getPanelIds(), e.forEach((a) => {
      this.panelOrder.find((r) => r.id === a) || this.addPanel(a);
  ...
  async scanFirstPanel() {
    ...
    this.panelTabsData[0] = [...r], await this.savePanelTabsByKey(x.FIRST_PANEL_TABS, r), this.log(`📋 第一个面板扫描并保存了 ${r.length} 个标签页`);
  }
  /**
   ...
   */
  sortTabsByPinStatus() {
    const e = this.getCurrentPanelTabs(), t = ia(e);
  ...
  async detectBlockType(e) {
    try {
      ...
      if (e["data-type"]) {
        const r = e["data-type"];
        switch (this.log(`🔍 检测到 data-type: ${r}`), r) {
          case "table2":
            return "table";
          case "ul":
            return "list";
      ...
      if (e.aliases && e.aliases.length > 0) {
        ...
        if (r)
          try {
            ...
            return i && i.value ? (this.log(`📄 通过 _hide 属性确认为页面: ${r} (hide=${i.value})`), "page") : (this.log(`🏷️ 通过 _hide 属性确认为标签: ${r} (hide=${i ? i.value : "undefined"})`), "tag");
          } catch (i) {
            return this.warn("使用 API 检测标签失败，回退到文本分析:", i), r.includes("#") || r.includes("@") || r.length < 20 && r.match(/^[a-zA-Z0-9_-]+$/) || r.match(/^[a-z]+$/i) ? "tag" : "page";
          }
        return "alias";
      }
      const a = this.findProperty(e, "_repr");
      if (a && a.type === ue.JSON && a.value)
        try {
          const r = typeof a.value == "string" ? JSON.parse(a.value) : a.value;
          if (r.type)
            return r.type;
        } catch {
        }
...
`).length > 1)
  ...
  getBlockTypeIcon(e) {
    ...
    let a = t[e];
    if (!a) {
      const r = this.getSmartIcon(e, t);
      r && (a = r);
    }
    return a || (a = t.default), a;
  }
  /**
   * 智能图标选择
   */
  getSmartIcon(e, t) {
    const a = e.toLowerCase(), r = {
      date: "ti ti-calendar",
      time: "ti ti-clock",
  ...
  async getTabInfo(e, t, a) {
    try {
      ...
      if (!r) return null;
      let i = "", n = "", o = "", c = !1, l = "";
      l = await this.detectBlockType(r), this.log(`🔍 检测到块类型: ${l} (块ID: ${e})`), r.aliases && r.aliases.length > 0 && this.log(`🏷️ 别名块详细信息: blockId=${e}, aliases=${JSON.stringify(r.aliases)}, 检测到的类型=${l}`);
      try {
        const d = oe(r);
        if (d)
          c = !0, i = Bt(d);
...
`)[0].trim();
            ...
            const h = r.text.match(/caption:\s*(.+)/i);
            h && h[1] ? u = h[1].trim() : u = r.text.trim();
          }
          i = u;
        } else
          i = `块 ${e}`;
      ...
      try {
        const d = this.findProperty(r, "_color"), u = this.findProperty(r, "_icon");
  ...
  async createTabsUI() {
    ...
    let t, a, r;
    if (this.isFixedToTop ? (t = { x: 0, y: 0 }, a = !1, r = window.innerWidth) : (t = this.isVerticalMode ? this.verticalPosition : this.position, a = this.isVerticalMode, r = this.verticalWidth), this.tabContainer = pa(
      a,
      t,
      r,
      e
  ...
  async updateTabsUI() {
    ...
    try {
      ...
      const t = this.tabContainer.querySelector(".drag-handle"), a = this.tabContainer.querySelector(".new-tab-button"), r = this.tabContainer.querySelector(".workspace-button");
  ...
  showNewTabButtonContextMenu(e) {
    ...
    t && t.remove();
    const a = document.documentElement.hasAttribute("data-theme") ? document.documentElement.getAttribute("data-theme") === "dark" : document.documentElement.classList.contains("dark") || ((h = (u = window.orca) == null ? void 0 : u.state) == null ? void 0 : h.themeMode) === "dark", r = document.createElement("div");
    r.className = "new-tab-context-menu";
    const i = 200, n = 140;
    let o = e.clientX, c = e.clientY;
    o + i > window.innerWidth && (o = window.innerWidth - i - 10), c + n > window.innerHeight && (c = window.innerHeight - n - 10), o = Math.max(10, o), c = Math.max(10, c), r.style.cssText = `
      position: fixed;
      left: ${o}px;
      top: ${c}px;
      background: var(--orca-color-bg-1);
    ...
    this.isFixedToTop && l.push(
      ...
      f.textContent = p.text, b.appendChild(f), b.addEventListener("mouseenter", () => {
        ...
        p.action && p.action(), r.remove();
      }), r.appendChild(b);
    }), document.body.appendChild(r);
    const d = (p) => {
      r.contains(p.target) || (r.remove(), document.removeEventListener("click", d));
    };
    setTimeout(() => {
    ...
    for (let a = 0; a < e.length; a++) {
      ...
      try {
        ...
        if (i) {
          ...
          o && o.type === 1 && (l = o.value), c && c.type === 1 && c.value && c.value.trim() ? d = c.value : d || (d = this.getBlockTypeIcon(n)), (r.blockType !== n || r.icon !== d || r.color !== l) && (e[a] = {
            ...r,
            blockType: n,
            icon: d,
            color: l
          }, this.log(`✅ 更新标签: ${r.title} -> 类型: ${n}, 图标: ${d}, 颜色: ${l}`), t = !0);
        }
      } catch (i) {
  ...
  async showWidthAdjustmentDialog() {
    ...
    e && e.remove();
    const t = this.verticalWidth, a = ga(
      this.verticalWidth,
      async (r) => {
        try {
  ...
  createTabElement(e) {
    ...
    const r = this.isVerticalMode && !this.isFixedToTop, i = _t(e, r);
    t.style.cssText = i;
    const n = Ut();
    ...
    return t.appendChild(n), this.isVerticalMode && !this.resizeHandle && this.enableDragResize(), t.title = Yt(e), t.addEventListener("click", (c) => {
      ...
      if (!c.target.closest(".sidebar, .side-panel, .panel-resize, .resize-handle, .orca-sidebar, .orca-panel, .orca-menu, .orca-recents-menu, [data-panel-id]") && this.draggingTab && this.draggingTab.blockId !== e.blockId) {
        ...
        this.debouncedSwapTab(e, this.draggingTab);
      }
    }), t.addEventListener("dragenter", (c) => {
      c.target.closest(".sidebar, .side-panel, .panel-resize, .resize-handle, .orca-sidebar, .orca-panel, .orca-menu, .orca-recents-menu, [data-panel-id]") || this.draggingTab && this.draggingTab.blockId !== e.blockId && (c.preventDefault(), c.stopPropagation());
    }), t.addEventListener("dragleave", (c) => {
      const l = t.getBoundingClientRect(), d = c.clientX, u = c.clientY, h = 5;
      d < l.left - h || d > l.right + h || u < l.top - h || u > l.bottom + h;
   ...
   */
  rgbToOklch(e, t, a) {
    const r = e / 255, i = t / 255, n = a / 255, o = (Q) => Q <= 0.04045 ? Q / 12.92 : Math.pow((Q + 0.055) / 1.055, 2.4), c = o(r), l = o(i), d = o(n), u = c * 0.4124564 + l * 0.3575761 + d * 0.1804375, h = c * 0.2126729 + l * 0.7151522 + d * 0.072175, p = c * 0.0193339 + l * 0.119192 + d * 0.9503041, b = 0.2104542553 * u + 0.793617785 * h - 0.0040720468 * p, f = 1.9779984951 * u - 2.428592205 * h + 0.4505937099 * p, m = 0.0259040371 * u + 0.7827717662 * h - 0.808675766 * p, y = Math.cbrt(b), v = Math.cbrt(f), T = Math.cbrt(m), k = 0.2104542553 * y + 0.793617785 * v + 0.0040720468 * T, S = 1.9779984951 * y - 2.428592205 * v + 0.4505937099 * T, $ = 0.0259040371 * y + 0.7827717662 * v - 0.808675766 * T, C = Math.sqrt(S * S + $ * $), N = Math.atan2($, S) * 180 / Math.PI, R = N < 0 ? N + 360 : N;
    return { l: k, c: C, h: R };
  }
  /**
   * OKLCH转RGB颜色空间
   */
  oklchToRgb(e, t, a) {
    const r = a * Math.PI / 180, i = t * Math.cos(r), n = t * Math.sin(r), o = e, c = i, l = n, d = o * o * o, u = c * c * c, h = l * l * l, p = 1.0478112 * d + 0.0228866 * u - 0.050217 * h, b = 0.0295424 * d + 0.9904844 * u + 0.0170491 * h, f = -92345e-7 * d + 0.0150436 * u + 0.7521316 * h, m = 3.2404542 * p - 1.5371385 * b - 0.4985314 * f, y = -0.969266 * p + 1.8760108 * b + 0.041556 * f, v = 0.0556434 * p - 0.2040259 * b + 1.0572252 * f, T = (C) => C <= 31308e-7 ? 12.92 * C : 1.055 * Math.pow(C, 1 / 2.4) - 0.055, k = Math.max(0, Math.min(255, Math.round(T(m) * 255))), S = Math.max(0, Math.min(255, Math.round(T(y) * 255))), $ = Math.max(0, Math.min(255, Math.round(T(v) * 255)));
    return { r: k, g: S, b: $ };
  }
  /**
   * 应用颜色调整（支持亮色和暗色模式）
  ...
  async toggleTabPinStatus(e) {
    const t = this.getCurrentPanelTabs(), a = Kt(e, t, {
      updateOrder: !0,
      saveData: !0,
      updateUI: !0
    });
  ...
  async createNewTab() {
    try {
      ...
      if (a.length >= this.maxTabs) {
        ...
        if (o !== -1) {
          const c = a[o];
          a.splice(o, 1), this.log(`🗑️ 删除末尾的非固定标签: "${c.title}" 来保持数量限制`);
        } else {
        ...
        a.splice(n, 0, r);
      this.syncCurrentTabsToStorage(a), await this.saveCurrentPanelTabs(), await this.updateTabsUI(), await orca.nav.goTo("block", { blockId: parseInt(e) }, this.currentPanelId || ""), this.log(`🔄 导航到块: ${e}`), this.log(`✅ 成功创建新标签页: "${r.title}"`);
    } catch (e) {
  ...
  async addTabToPanel(e, t, a = !1) {
    try {
      ...
      const o = await this.getTabInfo(e, this.currentPanelId || "", r.length);
      if (!o)
      ...
      if (t === "replace") {
        ...
        const u = r.findIndex((h) => h.blockId === d.blockId);
        if (u === -1)
      ...
      if (r.length >= this.maxTabs)
        if (l)
          ...
          if (d !== -1)
            ...
            const u = r.findIndex((h) => h.blockId === o.blockId);
            if (u !== -1)
              return r.splice(u, 1), !1;
          }
        }
      else
        l ? r[c] = o : r.splice(c, 0, o);
      return this.syncCurrentTabsToStorage(r), await this.saveCurrentPanelTabs(), this.enableWorkspaces && this.currentWorkspace && (await this.saveCurrentTabsToWorkspace(), this.log(`🔄 标签页添加，实时更新工作区: ${o.title}`)), await this.updateTabsUI(), a && await orca.nav.goTo("block", { blockId: parseInt(e) }, this.currentPanelId || ""), !0;
    } catch (r) {
    ...
    try {
      ...
      for (; r && r !== document.body; ) {
        ...
        if (i.contains("orca-ref") || i.contains("block-ref") || i.contains("block-reference") || i.contains("orca-fragment-r") || i.contains("fragment-r") || i.contains("orca-block-reference") || r.tagName.toLowerCase() === "a" && ((t = r.getAttribute("href")) != null && t.startsWith("#"))) {
          const o = r.getAttribute("data-ref-id") || r.getAttribute("data-target-block-id") || r.getAttribute("data-fragment-v") || r.getAttribute("data-v") || ((a = r.getAttribute("href")) == null ? void 0 : a.replace("#", "")) || r.getAttribute("data-id");
  ...
  isTabActive(e) {
    try {
      ...
      return i && this.closedTabs.has(e.blockId) ? !1 : i;
    } catch (t) {
  ...
  getCurrentActiveTab() {
    ...
    if (!r) return null;
    const i = e.find((n) => n.blockId === r) || null;
  ...
  showRenameInput(e) {
    ...
    n.addEventListener("click", l), o.addEventListener("click", d), r.addEventListener("keydown", (h) => {
      h.key === "Enter" ? (h.preventDefault(), l()) : h.key === "Escape" && (h.preventDefault(), d());
    });
    const u = (h) => {
      a.contains(h.target) || (d(), document.removeEventListener("click", u));
    };
    setTimeout(() => {
  ...
  async updateTabTitle(e, t) {
    try {
      const a = this.getCurrentPanelTabs(), r = ea(e, t, a, {
        updateUI: !0,
        saveData: !0,
        validateData: !0
      });
  ...
  addOrcaContextMenu(e, t) {
    ...
    if (!a || !r || !orca.components.ContextMenu || !orca.components.Menu || !orca.components.MenuText) {
      setTimeout(() => {
  ...
  showTabContextMenu(e, t) {
    ...
    a && a.remove();
    const r = document.documentElement.classList.contains("dark") || ((l = (c = window.orca) == null ? void 0 : c.state) == null ? void 0 : l.themeMode) === "dark", i = document.createElement("div");
    ...
    this.savedTabSets.length > 0 && n.push({
      ...
      u.textContent = d.text, u.style.cssText = `
        ...
        cursor: pointer;
        font-size: 14px;
        color: ${d.disabled ? r ? "#666" : "#999" : r ? "#ffffff" : "#333"};
        border-bottom: 1px solid var(--orca-color-border);
        transition: background-color 0.2s;
      ...
      if (!r.blockType || !r.icon)
        try {
          ...
          if (n) {
            ...
            let c = r.icon;
            c || (c = this.getBlockTypeIcon(o)), e[a] = {
              ...r,
              blockType: o,
              icon: c
  ...
  constrainPosition() {
    ...
    this.position = sa(this.position, this.isVerticalMode, this.verticalWidth, e);
  }
  /**
   * 检查新添加的块
   */
  ...
  updateFocusState(e, t) {
    ...
    a == null || a.forEach((o) => o.removeAttribute("data-focused"));
    const r = (n = this.tabContainer) == null ? void 0 : n.querySelector(`[data-tab-id="${e}"]`);
    r && (r.setAttribute("data-focused", "true"), this.log(`🎯 更新聚焦状态到已存在的标签: "${t}"`));
  }
  /**
  ...
  async checkCurrentPanelBlocks() {
    ...
    const a = this.getPanelIds().indexOf(t);
    a !== -1 && (this.currentPanelIndex = a, this.currentPanelId = t), e.querySelectorAll(".orca-hideable");
  ...
  observeChanges() {
    new MutationObserver(async (r) => {
      ...
      r.forEach((h) => {
        ...
        if (h.type === "attributes" && h.attributeName === "class") {
          ...
          p.classList.contains("orca-hideable") && !p.classList.contains("orca-hideable-hidden") && (i = !0);
        }
      ...
      }, 100)), i && await this.checkCurrentPanelBlocks();
    ...
    let t = null;
    const a = async (r) => {
      const n = r.target.closest(".orca-hideable");
      n && (t && clearTimeout(t), t = window.setTimeout(async () => {
        n.classList.contains("orca-hideable-hidden") || await this.checkCurrentPanelBlocks(), t = null;
      }, 0));
    };
    document.addEventListener("click", a), document.addEventListener("focusin", a), document.addEventListener("keydown", (r) => {
      ...
      try {
        ...
        if (i) {
          ...
          if (n) {
            const o = n.getAttribute("data-block-id");
            if (o) {
              const c = (r = this.tabContainer) == null ? void 0 : r.querySelector('.orca-tab[data-focused="true"]');
              c ? c.getAttribute("data-tab-id") !== o && await this.checkCurrentPanelBlocks() : await this.checkCurrentPanelBlocks();
            }
          }
        }
      } catch {
  ...
  async checkPanelStatusChange() {
    ...
    const i = this.getPanelIds()[0] || null, n = ba(a, this.getPanelIds());
  ...
  async showRecentlyClosedTabsMenu(e) {
    ...
    const t = e ? { x: e.clientX, y: e.clientY } : { x: 0, y: 0 }, a = this.recentlyClosedTabs.map((r, i) => ({
      label: `${r.title}`,
      icon: r.icon || this.getBlockTypeIcon(r.blockType || "default"),
  ...
  createRecentlyClosedTabsMenu(e, t) {
    ...
    a && a.remove();
    const r = document.documentElement.classList.contains("dark") || ((u = (d = window.orca) == null ? void 0 : d.state) == null ? void 0 : u.themeMode) === "dark", i = document.createElement("div");
  ...
  showSaveTabSetDialog() {
    ...
    }), b.appendChild(m), r.appendChild(u), r.appendChild(b), t.appendChild(r);
  ...
  showAddToTabGroupDialog(e) {
    ...
    const h = (p) => {
      a.contains(p.target) || (a.remove(), document.removeEventListener("click", h));
    };
    setTimeout(() => {
  ...
  renderSortableTabs(e, t, a) {
    ...
    t.forEach((c, l) => {
      ...
      `, f.textContent = (l + 1).toString(), b.appendChild(f), d.appendChild(b), d.addEventListener("dragstart", (m) => {
        i = l, m.dataTransfer.setData("text/plain", l.toString()), m.dataTransfer.setData("application/json", JSON.stringify(c)), m.dataTransfer.effectAllowed = "move", d.style.opacity = "0.5", d.style.transform = "rotate(2deg)";
  ...
  showSaveWorkspaceDialog() {
    ...
    e && e.remove();
    const t = document.documentElement.classList.contains("dark") || ((f = (b = window.orca) == null ? void 0 : b.state) == null ? void 0 : f.themeMode) === "dark", a = document.createElement("div");
    ...
    }, d.appendChild(u), d.appendChild(h), r.appendChild(i), r.appendChild(n), r.appendChild(o), r.appendChild(c), r.appendChild(l), r.appendChild(d), a.appendChild(r), document.body.appendChild(a), o.focus(), a.addEventListener("click", (m) => {
      m.target === a && a.remove();
    });
    const p = (m) => {
  ...
  showWorkspaceMenu(e) {
    ...
    r.className = "workspace-menu", r.style.cssText = `
      position: fixed;
    ...
    `, this.workspaces.length === 0) {
      ...
      this.workspaces.forEach((h) => {
        ...
        p.innerHTML = `
          ...
          <div style="flex: 1;">
            <div style="font-weight: 500; color: ${a ? "#ffffff" : "#333"};"">${h.name}</div>
            ${h.description ? `<div style="font-size: 12px; color: ${a ? "#999" : "#666"}; margin-top: 2px;">${h.description}</div>` : ""}
            <div style="font-size: 11px; color: ${a ? "#777" : "#999"}; margin-top: 2px;">${h.tabs.length}个标签</div>
          </div>
          ${this.currentWorkspace === h.id ? '<i class="ti ti-check" style="font-size: 14px; color: var(--orca-color-primary-5);"></i>' : ""}
        `, p.onclick = () => {
          r.remove(), this.switchToWorkspace(h.id);
        }, o.appendChild(p);
      });
    const c = document.createElement("div");
    c.style.cssText = `
    ...
    }, r.appendChild(i), r.appendChild(n), r.appendChild(o), r.appendChild(c), document.body.appendChild(r);
    const l = (h) => {
  ...
  manageWorkspaces() {
    ...
    `, c.textContent = "关闭", c.onclick = () => {
      a.remove();
    }, o.appendChild(c), r.appendChild(i), r.appendChild(n), r.appendChild(o), a.appendChild(r), document.body.appendChild(a), a.querySelectorAll(".delete-workspace-btn").forEach((h) => {
  ...
  renameTabSet(e, t, a) {
    ...
    h.className = "orca-button orca-button-primary", h.textContent = "保存", h.style.cssText = "", h.addEventListener("mouseenter", () => {
      ...
      e.name = b, e.updatedAt = Date.now(), await this.saveSavedTabSets(), i.remove(), a.remove(), this.manageSavedTabSets(), orca.notify("success", "重命名成功");
  ...
  async editTabSetIcon(e, t, a, r, i) {
    ...
    `, l.forEach((b) => {
      ...
      `, y.textContent = b.name, f.appendChild(m), f.appendChild(y), f.addEventListener("click", async (v) => {
        v.stopPropagation(), e.icon = b.value, e.updatedAt = Date.now(), await this.saveSavedTabSets(), r(), n.remove(), i && i.focus(), orca.notify("success", "图标已更新");
  ...
  async manageSavedTabSets() {
    ...
    `, this.savedTabSets.forEach((c, l) => {
      ...
      }, y.appendChild(v), y.appendChild(T), y.appendChild(k), d.appendChild(u), d.appendChild(y), r.appendChild(d);
    }), t.appendChild(r);
    const i = document.createElement("div");
    i.style.cssText = `
      padding: 20px;
  ...
  trackOptimizedResource(e, t, a, r) {
    return this.performanceOptimizer ? this.performanceOptimizer.trackEventListener(e, t, a, r) : (e.addEventListener(t, a, r), null);
  }
  /**
   * 销毁插件，清理所有资源
   */
...
let P = null;
async function va(s) {
  _ = s, orca.state.locale, P = new fa(_), document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", () => {
...
async function xa() {
  P && (P.unregisterHeadbarButton(), P.cleanupDragResize(), P.destroy(), P = null), orca.commands.unregisterCommand(`${_}.resetCache`);
}
export {
  va as load,
  xa as unload
