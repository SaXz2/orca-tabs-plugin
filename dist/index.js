...
const te = {
  ...
  昨天: "昨天",
  明天: "明天"
}, j = 6048e5, ne = 864e5, Y = Symbol.for("constructDateFrom");
function p(a, e) {
  return typeof a == "function" ? a(e) : a && typeof a == "object" && Y in a ? a[Y](e) : a instanceof Date ? new a.constructor(e) : new Date(e);
}
function y(a, e) {
  return p(e || a, a);
}
...
function S(a, e) {
  var o, c, l, d;
  const t = E(), n = (e == null ? void 0 : e.weekStartsOn) ?? ((c = (o = e == null ? void 0 : e.locale) == null ? void 0 : o.options) == null ? void 0 : c.weekStartsOn) ?? t.weekStartsOn ?? ((d = (l = t.locale) == null ? void 0 : l.options) == null ? void 0 : d.weekStartsOn) ?? 0, r = y(a, e == null ? void 0 : e.in), s = r.getDay(), i = (s < n ? 7 : 0) + s - n;
...
function re(a, e, t) {
  const [n, r] = z(
    ...
    a,
    e
  ), s = D(n), i = D(r), o = +s - N(s), c = +i - N(i);
  return Math.round((o - c) / ne);
}
function se(a, e) {
  const t = Q(a, e), n = p(a, 0);
...
function k(a) {
  return (e, t = {}) => {
    ...
    if (!s)
      return null;
    const i = s[0], o = n && a.parsePatterns[n] || a.parsePatterns[a.defaultParseWidth], c = Array.isArray(o) ? Se(o, (f) => f.test(i)) : (
...
const Me = /^(\d+)(th|st|nd|rd)?/i, Ce = /\d+/i, De = {
  narrow: /^(b|a)/i,
...
function Be(a, e) {
  const t = y(a, e == null ? void 0 : e.in), n = +C(t) - +se(t);
  return Math.round(n / j) + 1;
}
function G(a, e) {
  var d, f, I, v;
  const t = y(a, e == null ? void 0 : e.in), n = t.getFullYear(), r = E(), s = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((f = (d = e == null ? void 0 : e.locale) == null ? void 0 : d.options) == null ? void 0 : f.firstWeekContainsDate) ?? r.firstWeekContainsDate ?? ((v = (I = r.locale) == null ? void 0 : I.options) == null ? void 0 : v.firstWeekContainsDate) ?? 1, i = p((e == null ? void 0 : e.in) || a, 0);
  i.setFullYear(n + 1, 0, s), i.setHours(0, 0, 0, 0);
  const o = S(i, e), c = p((e == null ? void 0 : e.in) || a, 0);
...
function _e(a, e) {
  var o, c, l, d;
  const t = E(), n = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((c = (o = e == null ? void 0 : e.locale) == null ? void 0 : o.options) == null ? void 0 : c.firstWeekContainsDate) ?? t.firstWeekContainsDate ?? ((d = (l = t.locale) == null ? void 0 : l.options) == null ? void 0 : d.firstWeekContainsDate) ?? 1, r = G(a, e), s = p((e == null ? void 0 : e.in) || a, 0);
...
const w = {
  ...
  // Hour [1-12]
  h(a, e) {
    return u(a.getHours() % 12 || 12, e.length);
  },
  // Hour [0-23]
  H(a, e) {
    return u(a.getHours(), e.length);
  },
  // Minute
  m(a, e) {
    return u(a.getMinutes(), e.length);
  },
  // Second
  s(a, e) {
    return u(a.getSeconds(), e.length);
  },
  // Fraction of second
  S(a, e) {
  ...
  Y: function(a, e, t, n) {
    const r = G(a, n), s = r > 0 ? r : 1 - r;
    if (e === "YY") {
      const i = s % 100;
      return u(i, 2);
    }
    return e === "Yo" ? t.ordinalNumber(s, { unit: "year" }) : u(s, e.length);
  },
  ...
  w: function(a, e, t, n) {
    const r = Re(a, n);
    return e === "wo" ? t.ordinalNumber(r, { unit: "week" }) : u(r, e.length);
  },
  // ISO week of year
  I: function(a, e, t) {
    const n = Be(a);
    return e === "Io" ? t.ordinalNumber(n, { unit: "week" }) : u(n, e.length);
  },
  // Day of the month
  d: function(a, e, t) {
  ...
  D: function(a, e, t) {
    const n = Xe(a);
    return e === "Do" ? t.ordinalNumber(n, { unit: "dayOfYear" }) : u(n, e.length);
  },
  // Day of week
  E: function(a, e, t) {
    const n = a.getDay();
  ...
  K: function(a, e, t) {
    ...
    return e === "Ko" ? t.ordinalNumber(n, { unit: "hour" }) : u(n, e.length);
  },
  // Hour [1-24]
  k: function(a, e, t) {
    let n = a.getHours();
    return n === 0 && (n = 24), e === "ko" ? t.ordinalNumber(n, { unit: "hour" }) : u(n, e.length);
  },
  // Minute
  m: function(a, e, t) {
...
function U(a, e = "") {
  ...
  return s === 0 ? t + String(r) : t + String(r) + e + u(s, 2);
}
function A(a, e) {
  return a % 60 === 0 ? (a > 0 ? "-" : "+") + u(Math.abs(a) / 60, 2) : P(a, e);
}
function P(a, e = "") {
  const t = a > 0 ? "-" : "+", n = Math.abs(a), r = u(Math.trunc(n / 60), 2), s = u(n % 60, 2);
  return t + r + e + s;
}
const H = (a, e) => {
  switch (a) {
  ...
  return s.replace("{{date}}", H(n, e)).replace("{{time}}", K(r, e));
}, Je = {
  p: K,
  P: je
}, Qe = /^D+$/, ze = /^Y+$/, Ge = ["D", "DD", "YY", "YYYY"];
function Ke(a) {
  return Qe.test(a);
}
function Ve(a) {
...
function Ze(a, e, t) {
  const n = et(a, e, t);
  if (console.warn(n), Ge.includes(a)) throw new RangeError(n);
}
function et(a, e, t) {
...
function X(a, e, t) {
  var d, f, I, v;
  const n = E(), r = n.locale ?? He, s = n.firstWeekContainsDate ?? ((f = (d = n.locale) == null ? void 0 : d.options) == null ? void 0 : f.firstWeekContainsDate) ?? 1, i = n.weekStartsOn ?? ((v = (I = n.locale) == null ? void 0 : I.options) == null ? void 0 : v.weekStartsOn) ?? 0, o = y(a, t == null ? void 0 : t.in);
  if (!oe(o))
    throw new RangeError("Invalid time value");
  let c = e.match(nt).map((g) => {
    const m = g[0];
    if (m === "p" || m === "P") {
      const O = Je[m];
      return O(g, r.formatLong);
    }
    return g;
  }).join("").match(tt).map((g) => {
    if (g === "''")
  ...
  return c.map((g) => {
    ...
    const m = g.value;
    (Ve(m) || Ke(m)) && Ze(m, e, String(a));
    const O = q[m[0]];
    return O(o, m, r.localize, l);
  }).join("");
}
function it(a) {
  const e = a.match(at);
...
class ht {
  ...
  async init() {
    try {
      this.maxTabs = orca.state.settings[B.CachedEditorNum] || 10;
    } catch {
      console.warn("无法读取最大标签数设置，使用默认值10");
    }
    this.restorePosition(), this.discoverPanels(), this.restoreFirstPanelTabs(), this.firstPanelTabs.length > 0 ? console.log("检测到持久化数据，使用固化的标签页状态") : (console.log("首次使用，扫描第一个面板创建标签页"), await this.scanFirstPanel()), await this.createTabsUI(), this.observeChanges(), this.observeWindowResize(), this.startActiveMonitoring(), this.isInitialized = !0, console.log("✅ 插件初始化完成");
  }
  /**
   * 发现所有面板
   */
  discoverPanels() {
    ...
    if (this.panelIds = [], console.log(`🔍 在 .orca-panels-row 中找到 ${r.length} 个 .orca-panel 元素`), r.forEach((s, i) => {
      const o = s.getAttribute("data-panel-id"), c = s.classList.contains("active"), l = s.offsetParent !== null, d = s.getBoundingClientRect(), f = this.isMenuPanel(s);
      console.log(`面板 ${i + 1}: ID=${o}, 激活=${c}, 可见=${l}, 菜单=${f}, 位置=(${d.left}, ${d.top})`), o && !f ? this.panelIds.push(o) : f ? console.log(`🚫 跳过菜单面板: ${o}`) : console.warn(`❌ 面板 ${i + 1} 没有 data-panel-id 属性`);
  ...
  async scanFirstPanel() {
    ...
    const n = [];
    let r = 0;
    const s = t.querySelectorAll(".orca-hideable");
    for (const i of s) {
    ...
    this.mergeFirstPanelTabs(n), this.saveFirstPanelTabs(), await this.updateTabsUI();
  }
  /**
   * 合并第一个面板的标签页
   */
  mergeFirstPanelTabs(e) {
    const t = new Set(this.firstPanelTabs.map((n) => n.blockId));
    for (const n of e)
      if (!t.has(n.blockId)) {
        if (this.firstPanelTabs.length >= this.maxTabs)
          break;
        this.firstPanelTabs.push(n);
      }
  ...
  formatJournalDate(e) {
    try {
      let t = orca.state.settings[B.JournalDateFormat];
      return (!t || typeof t != "string") && (t = (orca.state.locale || "zh-CN").startsWith("zh") ? "yyyy年MM月dd日" : "yyyy-MM-dd"), ot(e) ? $("今天") : ut(e) ? $("昨天") : ct(e) ? $("明天") : this.formatDateWithPattern(e, t);
    } catch (t) {
  ...
  async getTabInfo(e, t, n) {
    try {
      ...
      try {
        const l = this.findProperty(r, "_color"), d = this.findProperty(r, "_icon");
  ...
  async createTabsUI() {
    ...
    e.className = "drag-handle", e.style.cssText = `
      ...
      app-region: no-drag;
      pointer-events: auto;
    `, e.innerHTML = "⋮⋮", e.addEventListener("mousedown", this.startDrag.bind(this)), this.tabContainer.appendChild(e), document.body.appendChild(this.tabContainer), console.log(`✅ 标签容器已创建，位置: (${this.position.x}, ${this.position.y})`), await this.updateTabsUI();
  }
  /**
   * 防抖更新标签页UI（防止闪烁）
   */
  ...
  async updateTabsUI() {
    ...
    n && r ? (console.log("📋 显示第一个面板的固化标签页"), this.firstPanelTabs.forEach((s, i) => {
      var c;
  ...
  createTabElement(e) {
    ...
    `;
    let i = e.title;
    return e.icon && (i = `${e.icon} ${e.title}`), t.textContent = i, t.title = e.title, t.addEventListener("click", (o) => {
      ...
      var c;
      (c = o.dataTransfer) == null || c.setData("text/plain", e.blockId), t.style.opacity = "0.5";
      ...
      var l;
      o.preventDefault();
      const c = (l = o.dataTransfer) == null ? void 0 : l.getData("text/plain");
      c && c !== e.blockId && this.reorderTabs(c, e.blockId);
   ...
   */
  async reorderTabs(e, t) {
    if (this.currentPanelIndex !== 0) return;
    const n = this.firstPanelTabs.findIndex((s) => s.blockId === e), r = this.firstPanelTabs.findIndex((s) => s.blockId === t);
    if (n !== -1 && r !== -1 && n !== r) {
      const s = this.firstPanelTabs.splice(n, 1)[0];
      this.firstPanelTabs.splice(r, 0, s), this.debouncedUpdateTabsUI(), this.saveFirstPanelTabs();
    }
  }
  /**
  ...
  async checkFirstPanelBlocks() {
    const e = this.panelIds[0], t = document.querySelector(`.orca-panel[data-panel-id="${e}"]`);
    if (!t || this.firstPanelTabs.length >= this.maxTabs)
      return;
    const n = new Set(this.firstPanelTabs.map((s) => s.blockId)), r = t.querySelectorAll(".orca-hideable");
    for (const s of r) {
      if (this.firstPanelTabs.length >= this.maxTabs) {
      ...
      c && (this.firstPanelTabs.push(c), console.log(`添加新标签: ${c.title} (ID: ${o})`));
    }
    this.saveFirstPanelTabs(), this.debouncedUpdateTabsUI();
  }
  observeChanges() {
   ...
   */
  async resetCache() {
    console.log("🔄 开始重置插件缓存..."), this.firstPanelTabs = [];
    try {
      const e = this.getStorageKey();
      localStorage.removeItem(e), console.log(`🗑️ 已删除localStorage缓存: ${e}`);
    } catch (e) {
  ...
  destroy() {
    this.tabContainer && (this.tabContainer.remove(), this.tabContainer = null), this.cycleSwitcher && (this.cycleSwitcher.remove(), this.cycleSwitcher = null), this.monitoringInterval && (clearInterval(this.monitoringInterval), this.monitoringInterval = null), this.updateDebounceTimer && (clearTimeout(this.updateDebounceTimer), this.updateDebounceTimer = null), this.clickListener && (document.removeEventListener("click", this.clickListener), this.clickListener = null), this.keyListener && (document.removeEventListener("keydown", this.keyListener), this.keyListener = null);
  }
}
let b = null;
async function mt(a) {
  M = a, ee(orca.state.locale, { "zh-CN": te }), b = new ht(), document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", () => {
    ...
    "重置插件缓存"
  ), console.log($("标签页插件已启动")), console.log(`${M} loaded.`);
}
async function gt() {
  b && (b.destroy(), b = null), orca.commands.unregisterCommand(`${M}.resetCache`);
}
export {
  mt as load,
  gt as unload
